 ...
 * <p/>
 */
public class Neural1H implements Serializable {
	private static final long serialVersionUID = -7448316812982277150L;
    ...
    public Neural1H(int num_in, int num_hidden, int num_output) {
        numInputs = num_in;
    ...
    public static Neural1H Factory(String serialized_file_name) {
        Neural1H nn = null;
        try {
